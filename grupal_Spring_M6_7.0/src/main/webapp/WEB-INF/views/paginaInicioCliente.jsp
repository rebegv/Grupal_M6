...
<head>
    ...
    <style>
        body {
            background-image: url("https://platinoweb.com/images/servicios/diseno_de_paginas_web/cursos.jpg");
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="PaginaBienvenidaCliente.jsp">Inicio</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Administrar Asistentes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Gestionar Accidentes</a>
                </li>
                <li class="nav-item">
