...
<head>
    ...
    <style>
        body {
            background-image: url("https://cdn2.hubspot.net/hub/1817347/file-4089489260-jpg/blog-files/4-indicadores-capacitaci%C3%B3n.jpg");
            background-size: cover;
            background-repeat: no-repeat;
            background-attachment: fixed;
        }
    </style>
    <title>Bienvenida Profesional</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="PaginaBienvenidaProfesional.jsp">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Visitas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Chequeos</a>
                </li>
                <li class="nav-item">
